...
final class RealCoordinateConverterTest: XCTestCase {
  ...
  func test_that_conversion_from_meter_to_latlng_and_back_again_100_000_times_gives_us_acceptable_and_expected_results() {
  ...
  private let expectedLatLngCoordinates: [CLLocationCoordinate2D] = [
    ...
    .init(latitude: 59.35375806207805, longitude: 17.95703739810693), // this latitude has been changed to account for the difference.
    .init(latitude: 59.35293000000001, longitude: 17.9559)
  ]
